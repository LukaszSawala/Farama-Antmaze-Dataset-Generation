...
config = {
    ...
    "total_timesteps": 10_000_000, # recommended to use ~30m steps, best performance reachable at ~60m but diminishing returns
...
if __name__ == "__main__":
    ...
    # append the runname with a random id

    run_name = "ant-goal-reach" + wandb.util.generate_id()
    ...
    # Save a checkpoint every 500k steps
    checkpoint_callback = CheckpointCallback(
        save_freq= 500_000 // config["n_envs"],
